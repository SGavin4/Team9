...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    #
        ...
        if getting_team_name:
            # James B, Kailee, Chris
            return 'Happyfartkittens'
        else:
            if len(opponent_history)==0: #It's the first round: collude
                return 'c'
            else:
    ...
    #
        ...
        if getting_team_name:
            ...
            # Jacob D and Evan A
            return 'The Flaming Flamboyant Fuchsia Flamingos'
        else:
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if len(opponent_history)==0: #It's the first round: collude
                return 'c'
            if len(opponent_history)==1: #Collude 2nd round
                return 'c'
            if len(opponent_history)==2: #Betray 3rd round
                return 'b'
            if len(opponent_history)==3: #Collude 4th round
                return 'c'
            if len(opponent_history)==4: #Collude 5th round
                return 'c'
            if len(opponent_history)==5: #Betray 6th round
                return 'b'
            if len(opponent_history)==6: #Betray 7th round
                return 'b'
    ...
    #
        ...
        if getting_team_name:
            ...
            if len(opponent_history)==0: #It's the first round: collude
                ...
                return 'b' # betray if they were severely punished last time
            if len(opponent_history)>2 and opponent_history[-2]=='b': 
                return 'b'
    ...
    #
        ...
        if getting_team_name:
            # Ben M and Michael M
            return 'Michael Meyers'
        else:
            # use history, opponent_history, score, opponent_score
            # to compute your strategy
            if len(opponent_history)==0:
                return 'c'
            elif 'b' in opponent_history:
                return 'b'
            else:
                return 'c'
